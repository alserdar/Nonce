...
public class MoviesBroadCast extends BroadcastReceiver {
    public MoviesBroadCast() {
    }

    @Override
    public void onReceive(Context context, Intent intent)
    {
        setMoviesNotification(context);
    }

    public static void setMoviesNotification(Context context) {
        try {
            ...
            int selectedHour = savedMusicDetails.getInt("selectHourMovies", 21);
            int selectedMinute = savedMusicDetails.getInt("selectMinuteMovies", 9);

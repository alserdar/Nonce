package twitter.nonce_app.get_country;
...
import twitter.nonce_app.travel.TravelActivity;
...
public class GetCountryBySimCard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (Country != null) {
                    switch (Country.toUpperCase())
                    {
                        ...
                        case "ZW" :currentCountry = "Zimbabwe";
                            break;
                        default:currentCountry = "Undefined";
                            break;
                    }
                }
                break;
        ...
        if (whoIsComing != null) {
            if (whoIsComing.equals("hangoutCountry"))
            {
                Intent i = new Intent(GetCountryBySimCard.this , HangoutActivity.class);
                i.putExtra("countryIs" ,currentCountry);
                startActivity(i);
            }else if (whoIsComing.equals("travelCountry"))
            {
                Intent i = new Intent(GetCountryBySimCard.this , TravelActivity.class);
                i.putExtra("countryIs" ,currentCountry);
                startActivity(i);
            }
        }

...
public class SMSBroadCast extends BroadcastReceiver {
    ...
    public static final String CONTACT_NUMBER_FOR_SMS = "contactNumberForSMS";
    public static final String CONTACT_NAME_FOR_SMS = "contactNameForSMS";
    public static final String MESSAGE_BODY_FOR_SMS = "messageBodyForSMS";
    ...
    private static PendingIntent createPendingIntent(Context context, Model model) {
        ...
        intent.putExtra(CONTACT_NAME_FOR_SMS , model.contactNameForSMS);
        intent.putExtra(CONTACT_NUMBER_FOR_SMS , model.contactNumberForSMS);
        intent.putExtra(MESSAGE_BODY_FOR_SMS , model.messageBodyForSMS);

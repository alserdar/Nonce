...
public class CallBroadcast extends BroadcastReceiver {
    ...
    public static final String WHY_CALL = "whyCall";
    ...
    private static PendingIntent createPendingIntent(Context context, Model model) {
        ...
        intent.putExtra(WHY_CALL, model.whyCall);
        intent.putExtra(CONTACT_NAME, model.contactName);
        intent.putExtra(CONTACT_NUMBER, model.contactNumber);
